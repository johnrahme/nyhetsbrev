...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="force-row" style="width: 600px;">
  <tr>
    <td class="content-wrapper" style="padding-left:16px;padding-right:16px">
      <br>
      <img src="http://www.futf.se/img/nyhetsbrev/topbanner.gif" border="0" alt="The White Whale" width="700" height="90" hspace="0" vspace="0" style="max-width:100%; " class="banner">
    </td>
  </tr>
    <tr>
    ...
    <!--[if mso]>
      ...
      <tr><td width="288" style="width: 288px;" valign="top"><![endif]-->
        ...
        <table width="288" border="0" cellpadding="0" cellspacing="0" align="left" class="force-row" style="width: 288px;">
          <tr>
            <td class="col" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px">
             <img src="http://www.futf.se/img/nyhetsbrev/styrelsen.jpg" border="0" alt="Styrelsen hälsar" width="200" height="130" hspace="0" vspace="0" style="max-width:100%; " class="image">
