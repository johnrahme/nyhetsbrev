...
<link rel="stylesheet" type="text/css" href="css/mail/sidebar/email.css" />
	...
	<tr>
		...
		<td class="header container">
			...
			<table bgcolor="#FFFFFF" class="">
				<tr>
					<td><img src="http://www.futf.se/img/nyhetsbrev/topbanner.gif" /></td>
				</tr>
			</table>
			</div>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<div class="content">
				<table>
					<tr>
						<td>
							<h1>Hej alla tekniska fysiker!</h1>
							<p class="lead">Här kommer månadens nyhetsbrev, höstliga hälsningar från alla oss i sytrelsen</p>

							<!-- A Real Hero (and a real human being) -->
							<p><img src="http://www.futf.se/img/nyhetsbrev/styrelsen.jpg" /></p><!-- /hero -->
						...
						<tr>
							<td>
								...
								<ul class="sidebar">
									<li>
										<a>
											<h5>Intressanta länkar &raquo;</h5>
											<p>Sub-head or something</p>
										</a>
									</li>
									<li><a href = "http:\\www.google.se" class="">Kolla in den nya sidan google!&raquo;</a></li>
